public class ControlStatementsLecture {
  public static void main(String[] args) {
    ...
    /*Booleans / Logical Operators and Control Structures*/

    // ==================== Slide 3

    // no >== ,or <==, or === because only value comparisons are available
    // truthy and falsy values don't exist in Java there is no ===
...
//    int y = 3;
//
//    if (false && ++x == y) { //if false increment x ..with one & it gives me a 3, with && it doesnt increment
